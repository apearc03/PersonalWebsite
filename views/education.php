	  ...
	  <div class="container-fluid" id = "bsc">
		...
		<div class="container-fluid" id = "gcseBlock">
		  			<div class = "col-lg GCSEs">
		  				<h2>10 A-C GCSEs</h2>
					    <p>
					    	Between 2007 and 2009 I took 10 GCSEs at <a href = "http://www.oakgrove.school/" alt = "Oak">Oakgrove Secondary School</a> in Milton Keynes and achieved an A-C grade in all of them.
						 <p>   
					<ul class="list-group ">
						<li class = "module">
			    	 	...
			    	 	<li class = "module">
				      	...
				      	<li class = "module">
				      		Grade C in Humanities Studies.
				      	</li>
				      	<li class = "module">
				      		Grade C in Business Studies.
				      	</li>
				      	<li class = "module">

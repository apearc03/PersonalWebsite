				...
				<div class = "col-6">
					<h1 class = "heading">PricewaterhouseCoopers</h1>
						<p><Strong>Data Assurance Intern</Strong> - July 2017 -September 2017</p>
				   		...
				   		<p>I had a lot of exposure to technologies including:</p>

				   		 <ul class="list-group" id = "techs">
							<li class = "module">
			     		...
			     		<p id ="mainTask">The main project I was tasked with involved developing a dashboard within Qlik Sense to display utilisation of the Data Assurance team's hours. This meant creating a visually effective display of statistics and key performance indicators.</p>
